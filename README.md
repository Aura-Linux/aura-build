...
Aura is built using a Docker container, which when run produces the final image for distribution.
...
* ``aura-ui.service`` starts the PHP Webserver for the Aura Web UI.
